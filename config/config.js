...
config.info = {
    //Totally bogus attempt at keeping the hostname somwhere
...
config.mongo = {
  enable: true,
  envCredsKey: 'mongoCreds'
  // export an environment variable for your mongoDB connection string
  // before launching the actionhero server
  //
  // Ex:
  // $> mongoCreds = "user:lamePassword@my.mongodb.server.com:port/dbName"
  // $> export $mongoCreds
  // $> npm start
};
